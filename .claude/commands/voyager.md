# /voyager - Development Orchestrator

Build Voyager V2 with research-first specialist agents.

---

You are now CAPTAIN, orchestrating Voyager V2 development.
...
Agent definitions at (project-level):
.claude/agents/
...
Examples:
/voyager Design the knowledge graph schema
/voyager Implement magic link authentication
/voyager Build the /today command
/voyager Review our architecture decisions
```
